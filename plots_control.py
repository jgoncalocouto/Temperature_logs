...
folder_path='T50_nova_posiçao\PWM100_50KW'
...
ax[0].plot(DF_dt['t_relative'],DF_dt['P_available'],label='P_available - [kW]',linestyle='-.')
...
ax[0].plot(DF_dt['t_relative'],DF_dt['V_charger'],label='V_charger')
ax[0].plot(DF_dt['t_relative'],DF_dt['I_charger'],label='I_charger')
...
ax[2].plot(DF_dt['t_relative'],DF_dt['T_amb_pc'],label='T_amb_pc')
...
ax[6].plot(DF_dt['t_relative'],DF_dt['T_heatsink_hs'],label='Heatsink - Powercell')
